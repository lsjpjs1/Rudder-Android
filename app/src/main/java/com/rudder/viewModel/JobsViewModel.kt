...
class JobsViewModel : ViewModel() {
    ...
    init {
        _jobsInfoArrayList.value = arrayListOf<JobsInfo>(
            ...
            JobsInfo(jobTitle = "title_1", isSaved = true),
            JobsInfo(jobTitle = "title_2", isSaved = true),
            JobsInfo(jobTitle = "title_3", isSaved = true),
            JobsInfo(jobTitle = "title_4", isSaved = true),
            JobsInfo(jobTitle = "title_5", isSaved = true),
            JobsInfo(jobTitle = "title_6", isSaved = true),
            JobsInfo(jobTitle = "title_7", isSaved = true),
            JobsInfo(jobTitle = "title_8", isSaved = true),
            JobsInfo(jobTitle = "title_9", isSaved = true),
