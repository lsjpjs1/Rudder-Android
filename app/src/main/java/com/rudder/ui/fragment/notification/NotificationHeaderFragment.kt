 ...
 * Use the [NotificationHeaderFragment.newInstance] factory method to
...
class NotificationHeaderFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment NotificationHeaderFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            NotificationHeaderFragment().apply {
